...
-- #################################
/*
	1.	PostgreSQL offers data types to store IPv4, IPv6 and MAC address
...
-- 1.	Lets build a sample table with an IP address for IPv4 and IPv6 network address type i.e inet
